...
void AtomicSubshellDialog::on_pushButton_addAugerTransition_clicked()
{
    ...
    QString transition = QString("%1 %2").arg(ui->comboBox_occupancy->currentText(),ui->comboBox_emitting->currentText());
...
void AtomicSubshellDialog::on_pushButton_addXRayTransition_clicked()
{
    ...
    QString transition = QString("%1").arg(ui->comboBox_occupancy_x->currentText());
